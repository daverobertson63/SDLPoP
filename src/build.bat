...
set CommonLinkerFlags= /subsystem:windows,7.01 /libpath:"%SDL2%\lib\%VSCMD_ARG_TGT_ARCH%" Shell32.lib SDL2main.lib SDL2.lib SDL2_image.lib icon.res /out:..\prince.exe
